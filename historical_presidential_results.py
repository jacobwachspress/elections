...
def main():
    ...
    output_path = money_path + "foundation/raw/"
    output_path += "pres_results_by_state_leg_district/"
    ...
    for file in os.listdir(input_path):
        ...
        for ix in race_indices:
            ...
            col_one = df.columns[ix + 1]
            new_names[col_one] = df1.loc[0, col_one] + ' ' + col + ' R'
        ...
        # add _Upper to file names without chamber specified
        # (manually checked -- this is right)
        if '_' not in file:
