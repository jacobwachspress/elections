...
races_df = pd.read_csv("G:\\Shared drives\\princeton_gerrymandering_project\\Moneyball\\state\\all_input_data.csv")

# read in and merge foundations margin
pred_path = "G:\\Shared drives\\princeton_gerrymandering_project\\Moneyball\\foundation\\clean\\foundations_predictions_2020_old.csv"
...
to_test = pd.read_csv("G:\\Shared drives\\princeton_gerrymandering_project\\Moneyball\\state\\states_to_test.csv")
...
error_vars = {}
err_df = pd.read_csv("G:\\Shared drives\\princeton_gerrymandering_project\\Moneyball\\state\\correlated_error.csv")
